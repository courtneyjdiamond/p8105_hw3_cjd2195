...
I generated two plots for this question, and I think each of them has their own merit depending on what the reader is looking for from a visualization of this data. The first plot is a density plot, and provides a good "quick" visual that generally shows us how the distributions differed between the two time points, but the boxplot provides more information about the mean, IQR, and outliers and is (probably) preferred by those who really want to extract these details from a visual. 
